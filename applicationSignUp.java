...
public class applicationSignUp extends JFrame {
    ...
    public applicationSignUp() {
        ...
        // setting the default values for the grid bag layout manager.
        gbc.weightx = 100;
        gbc.weighty = 100;
        ...
        // creates a new panel that holds the button and uses the box layout so that it can be placed where I wanted it to be in the frame.
